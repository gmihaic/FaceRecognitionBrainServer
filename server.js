...
// get all profiles
app.get('/', (req, res) => { profileController.handleAllProfiles(req, res, db); } );

//profile/:userId --> GET = user profile
app.get('/profile/:id', (req, res) => { profileController.handleUserProfile(req, res, db); } );

//topforuser/:user_id/:limit --> GET = top images for user
app.get('/topforuser/:user_id/:limit', (req, res) => { profileController.handleUserTopImages(req, res, db); } );

///signin --> POST = success/fail
app.post('/signin', (req, res) => { userController.handleSignin(req, res, db, bcrypt, is_email_valid); } );

//register --> POST = user
app.post('/register', (req, res) => { userController.handleRegister(req, res, db, bcrypt, is_email_valid); } );
